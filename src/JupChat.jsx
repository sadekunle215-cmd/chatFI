...
const MULTIPLY_VAULTS = [
  ...
  // colMint/debtMint: sent to /api/multiply so it doesn't need @jup-ag/lend-read to look them up.
  { id:"jupsol-sol",  vaultId:3,  collateral:"JupSOL", debt:"SOL",  colDecimals:9, debtDecimals:9, colMint:"jupSoLaHXQiZZTSfEWMTRRgpnyFm8f6sZdosWBjx93v", debtMint:"So11111111111111111111111111111111111111112",  maxLev:"10x", ltv:"90%", desc:"Loop JupSOL vs SOL. Earn staking yield amplified. Best for SOL bulls.", risk:"Medium", url:"https://jup.ag/lend/multiply/jupsol-sol"  },
  { id:"jitosol-sol", vaultId:2,  collateral:"JitoSOL",debt:"SOL",  colDecimals:9, debtDecimals:9, colMint:"J1toso1uCk3RLmjorhTtrVwY9HJ7X8V9yYac6Y7kGCPn",  debtMint:"So11111111111111111111111111111111111111112",  maxLev:"10x", ltv:"90%", desc:"Loop JitoSOL vs SOL. Earn Jito staking + MEV rewards amplified.",      risk:"Medium", url:"https://jup.ag/lend/multiply/jitosol-sol" },
  { id:"sol-usdc",    vaultId:1,  collateral:"SOL",    debt:"USDC", colDecimals:9, debtDecimals:6, colMint:"So11111111111111111111111111111111111111112",        debtMint:"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", maxLev:"5x",  ltv:"80%", desc:"Leverage SOL exposure against USDC. Higher upside and downside.",       risk:"High",   url:"https://jup.ag/lend/multiply/sol-usdc"    },
  { id:"jlp-usdc",    vaultId:5,  collateral:"JLP",    debt:"USDC", colDecimals:6, debtDecimals:6, colMint:"27G8MtK7VtTcCHkpASjSDdkWWYfoqT6ggEuKidVJidD4",    debtMint:"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", maxLev:"5x",  ltv:"90%", desc:"Loop JLP (Jupiter LP token) vs USDC. Earn JLP fees amplified.",         risk:"Medium", url:"https://jup.ag/lend/multiply/jlp-usdc"    },
  { id:"usdc-usdt",   vaultId:7,  collateral:"USDC",   debt:"USDT", colDecimals:6, debtDecimals:6, colMint:"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",    debtMint:"Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB",  maxLev:"20x", ltv:"95%", desc:"Stable-stable loop. Very low risk, amplify stablecoin yield.",           risk:"Low",    url:"https://jup.ag/lend/multiply"             },
  { id:"wbtc-usdc",   vaultId:4,  collateral:"WBTC",   debt:"USDC", colDecimals:8, debtDecimals:6, colMint:"3NZ9JMVBmGAqocybic2c7LQCJScmgsAZ6vQqTDzcqmJh",    debtMint:"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", maxLev:"5x",  ltv:"80%", desc:"Leverage BTC exposure against USDC.",                                   risk:"High",   url:"https://jup.ag/lend/multiply/wbtc-usdc"   },
  { id:"jup-usdc",    vaultId:6,  collateral:"JUP",    debt:"USDC", colDecimals:6, debtDecimals:6, colMint:"JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN",     debtMint:"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", maxLev:"4x",  ltv:"75%", desc:"Use JUP as collateral, loop to amplify JUP exposure.",                   risk:"High",   url:"https://jup.ag/lend/multiply"             },
];
    ...
    try {
      ...
      const res = await fetch("/api/multiply", {
        ...
        body: JSON.stringify({
          ...
          signer:           walletFull,
          colMint:          vault.colMint,   // mint address — avoids @jup-ag/lend-read on backend
          debtMint:         vault.debtMint,  // mint address — avoids @jup-ag/lend-read on backend
        }),
      });
