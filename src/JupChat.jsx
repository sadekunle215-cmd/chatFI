...
const MULTIPLY_VAULTS = [
  { id:"jupsol-sol",   collateral:"JupSOL", debt:"SOL",  maxLev:"10x", ltv:"90%", desc:"Loop JupSOL vs SOL. Earn staking yield amplified. Best for SOL bulls.", risk:"Medium",  url:"https://jup.ag/lend/multiply/jupsol-sol"  },
  { id:"jitosol-sol",  collateral:"JitoSOL",debt:"SOL",  maxLev:"10x", ltv:"90%", desc:"Loop JitoSOL vs SOL. Earn Jito staking + MEV rewards amplified.",      risk:"Medium",  url:"https://jup.ag/lend/multiply/jitosol-sol" },
  { id:"sol-usdc",     collateral:"SOL",    debt:"USDC", maxLev:"5x",  ltv:"80%", desc:"Leverage SOL exposure against USDC. Higher upside and downside.",       risk:"High",    url:"https://jup.ag/lend/multiply/sol-usdc"    },
  { id:"jlp-usdc",     collateral:"JLP",    debt:"USDC", maxLev:"5x",  ltv:"90%", desc:"Loop JLP (Jupiter LP token) vs USDC. Earn JLP fees amplified.",         risk:"Medium",  url:"https://jup.ag/lend/multiply/jlp-usdc"    },
  { id:"usdc-usdt",    collateral:"USDC",   debt:"USDT", maxLev:"20x", ltv:"95%", desc:"Stable-stable loop. Very low risk, amplify stablecoin yield.",           risk:"Low",     url:"https://jup.ag/lend/multiply"             },
  { id:"wbtc-usdc",    collateral:"WBTC",   debt:"USDC", maxLev:"5x",  ltv:"80%", desc:"Leverage BTC exposure against USDC.",                                   risk:"High",    url:"https://jup.ag/lend/multiply/wbtc-usdc"   },
  { id:"jup-usdc",     collateral:"JUP",    debt:"USDC", maxLev:"4x",  ltv:"75%", desc:"Use JUP as collateral, loop to amplify JUP exposure.",                   risk:"High",    url:"https://jup.ag/lend/multiply"             },
];
                  ...
                  <div key={v.id} style={{ padding:"12px 14px", background:T.bg, border:`1px solid ${T.border}`, borderRadius:10 }}>
                    ...
                    <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                      ...
                      <a href={v.url} target="_blank" rel="noreferrer"
                        style={{ padding:"5px 14px", background:T.accent, borderRadius:6, color:"#0d1117", fontSize:12, fontWeight:600, textDecoration:"none" }}>
                        Open on Jupiter →
                      </a>
                    </div>
                  </div>
